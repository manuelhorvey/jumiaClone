...
export const HomeOffice = [
    {
        'id': 1,
        'Image': Bruhm86Litres,
        'title': 'Bruhm 86 Litres - 086MD Table Top Refrigerator - Silver',
        'price': 'GHC 600'
    },
    {
        'id': 2,
        'Image': Bruhm132LSilver,
        'title': 'Bruhm 132L Silver - Double Door Refrigerator BRD-132TMDS',
        'price': 'GHC 1,200'
    },
    {
        'id': 3,
        'Image': BruhmAC,
        'title': 'Bruhm BAS-12RCEW Split Air Conditioner - 1.5HP - White',
        'price': 'GHC 1,800'
    },
    {
        'id': 4,
        'Image': DelronHotPlate,
        'title': 'Delron 2 Burner Electric Hot Plate - Black - 2000W',
        'price': 'GHC 150'
    },
    {
        'id': 5,
        'Image': DelronBlender,
        'title': 'Delron DB-1831 2 in 1 Blender - 1.5L Black',
        'price': 'GHC 100'
    },
    {
        'id': 6,
        'Image': DelronIron,
        'title': 'Delron DID-0023P Dry Pressing Iron - 2200 Watts - White/Blue',
        'price': 'GHC 80'
    },
    {
        'id': 7,
        'Image': DelronKettle,
        'title': 'Delron DK-001 Electric Kettle - 1.8 Litre - 3 Pin Plug - Black/Silver',
        'price': 'GHC 70'
    },
    {
        'id': 8,
        'Image': LindyShoeRack,
        'title': 'Lindy 4 Tier Shoe Rack - Black',
        'price': 'GHC 50'
    },
    {
        'id': 9,
        'Image': SolarLamp,
        'title': 'Solar Street Outdoor LED Lamp Flood Light - 200W - Black',
        'price': 'GHC 350'
    },
    {
        'id': 10,
        'Image': SyinixBlender,
        'title': 'Syinix Automatic Swallow Maker Fufu Pounding Blender - 1200W Silver/Black',
        'price': 'GHC 250'
    },
    {
        'id': 11,
        'Image': WestpointFridge,
        'title': 'Westpoint WRN-62219-ERWDX Side by Side Fridge With Dispenser - 556Litre - Gray',
        'price': 'GHC 3,500'
    }
];
